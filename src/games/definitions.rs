...
use crate::protocols::types::CustomProtocol;
use phf::{phf_map, Map};
...
pub static GAMES: Map<&'static str, Game> = phf_map! {
    ...
    "ffow" => game!("Frontlines: Fuel of War", 5478, Protocol::PROPRIETARY(CustomProtocol::FFOW)),
    ...
    "ts" => game!("The Ship", 27015, Protocol::PROPRIETARY(CustomProtocol::TheShip)),
    ...
    "jc2mp" => game!("Just Cause 2: Multiplayer", 7777, Protocol::PROPRIETARY(CustomProtocol::JC2MP)),
};
