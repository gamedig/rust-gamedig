...
pub static GAMES: Map<&'static str, Game> = phf_map! {
    ...
    "ffow" => game!("Frontlines: Fuel of War", 5478, Protocol::CUSTOM(CustomProtocol::FFOW)),
    ...
    "ts" => game!("The Ship", 27015, Protocol::CUSTOM(CustomProtocol::TheShip)),
    ...
    "jc2mp" => game!("Just Cause 2: Multiplayer", 7777, Protocol::CUSTOM(CustomProtocol::JC2MP)),
};
